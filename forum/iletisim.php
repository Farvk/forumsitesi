       ...
       <div id="carouselExampleIndicators" class="carousel slide brs" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="img/aa.jpg" class="d-block img-fluid" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="img/ab.jpg" class="d-block img-fluid" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="img/ac.jpg" class="d-block img-fluid" alt="...">
                </div>
              </div>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
  ...
  <div class="card-body">
    <h5 class="card-title">Ömer Faruk DERECİ</h5>
    <p class="card-text">farvkdereci@gmail.com   <br></p>
    <a href="https://www.github.com/Farvk" class="btn btn-primary">github için Tıkla.</a>
  </div>
